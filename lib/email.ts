                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f2ecdf;border:1px solid #ddd4bf;">
                  <tr>
                    <td style="padding:24px;">
                      ...
                      <a href="${escapeHtml(bookUrl)}" style="display:inline-block;background:#8e2c48;color:#faf7ef;text-decoration:none;font-family:Arial,Helvetica,sans-serif;font-size:14px;letter-spacing:0.04em;padding:14px 28px;">Discuss an operational bottleneck</a>
                    </td>
                  </tr>
                </table>
              </td>
